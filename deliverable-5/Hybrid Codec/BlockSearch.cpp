...
public:
    BlockSearch();
    ~BlockSearch();
    findBestBlock(Mat &frame, Mat &prevFrame, int x, int y, int &dx, int &dy);
};

// Constructor: Sets the block size and search area size
BlockSearch::BlockSearch(int blockSize, int searchSize, int stepSize=1)
{
...
vector<int> :: findBestBlock(Mat &prevFrame, Mat &block, int x_0, int y_0)
{
